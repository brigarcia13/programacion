...
system("clear");          
   	  ...
   	  cout<<"\n4.->trabajo del estudiange 4"<<endl; 
    	  cout<<"\n5.->Salir"""<<endl;                            cout<<"  "; cin>>a;                                     system("clear");                                                                                                 switch(a){                                              
   	  case 1: cout<<"\nEJERCICIOS DE GARCIA ARROYO BRITNEY"<<endl;                                                   cout<<"\n1.|-Compara dos numeros:"<<endl;
    	  ...
    	  system ("clear");
     	  	 switch (d) {                                     
    	  	 case 1: {ga_Compara();}break;                           case 2: {ga_CuentaMoneda();} break;                     case 3: {ga_Laedad();} break;                           case 4: {GA_SumaN();} break;                            case 5: {ga_PuntoVenta();} break;
    	  	  case 6: {cout<<"PARA SALIR PRESIONE (1)"; cout<<"     ";cout<<"PARA VOLVER AL MENU PRINCIPAL PRESIONE (2) "<<endl;  			cout<<"  ";                                             cin>>r;						        
   system("clear");
    	  	   					if (r==1){                                           
    	  	   					       return 0;}					     	  	   					       																						 }
     	  	   					       																						 															   }                                                            //=========================================================================================
